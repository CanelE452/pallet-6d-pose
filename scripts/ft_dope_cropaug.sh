...
PRETRAIN_W="weights/dope/dope_cropaug_pretrain/final_net_epoch_0060.pth"
S1_W="weights/dope/dope_cropaug_ft_s1/final_net_epoch_0150.pth"
...
echo "########## 완료 — best = weights/dope/dope_cropaug_ft_s2/final_net_epoch_0180.pth ##########"
