"""Saved output comparisons: R0 / SYN5k / fixed follow-up, all194 frames."""
import argparse
import html
...
def main(phase):
    module={'dino_diverse_continue':L,'dino_rgb_detail':T}[phase];module.verify()
    ...
    label={'dino_diverse_continue':'SYN 20k','dino_rgb_detail':'SYN RGB 5k'}[phase]
...
if __name__=='__main__':
    p=argparse.ArgumentParser();p.add_argument('phase',choices=['dino_diverse_continue','dino_rgb_detail']);main(p.parse_args().phase)
