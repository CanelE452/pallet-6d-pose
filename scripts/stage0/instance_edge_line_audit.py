...
real.
    ...
    python scripts/stage0/instance_edge_line_audit.py all
    python scripts/stage0/instance_edge_line_audit.py status
"""
...
RUNNER_PATH = STAGE0 / "instance_edge_learnability.py"
...
def phase_report(state) -> dict[str, Any]:
    ...
    write("LINE_HYPOTHESIS_PROVENANCE.md",
          "# Provenance\n\n```\n" + json.dumps({
              "runner": "scripts/stage0/instance_edge_line_audit.py",
