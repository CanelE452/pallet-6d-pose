...
SEM = _load("SEM_CAP", "scripts/stage0/structural_line_target_semantics.py")
...
def provenance():
    return {"runner_sha": V2.sha_file(pathlib.Path(__file__)),
            "target_semantics_sha": V2.sha_file(
                ROOT / "scripts/stage0/structural_line_target_semantics.py"),
            "hough_decoder_sha": V2.sha_file(
                ROOT / "scripts/stage0/structural_line_hough_decoder.py"),
