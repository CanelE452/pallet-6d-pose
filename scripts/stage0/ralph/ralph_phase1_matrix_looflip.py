...
Usage: RALPH_THRESH=0.1 python -u scripts/stage0/ralph/ralph_phase1_matrix.py
"""
...
MODELS = [
    ...
    ("R1\n(outside PL)", f"{RS}/h8_s2_outside_looflip/round_01.pth"),
    ("R1\n(night PL)", f"{RS}/h8_s2_night_looflip/round_01.pth"),
    ("R1\n(noapril PL)", f"{RS}/h8_s2_noapril_looflip/round_01.pth"),
    ("R2\n(outside PL)", f"{RS}/h8_s2_outside_looflip/round_02.pth"),
    ("R2\n(night PL)", f"{RS}/h8_s2_night_looflip/round_02.pth"),
...
OUT = os.path.join(ROOT, RS, "phase1style_cross_domain_s2_looflip.png")
...
def main():
    ...
    fig.suptitle("s2 loo+flip self-training — Cross-domain transfer matrix & best per-domain\n"
