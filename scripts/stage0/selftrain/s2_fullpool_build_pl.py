...
Usage: python -u scripts/stage0/selftrain/s2_fullpool_build_pl.py <infer_dir> <out_name>
  예: python -u scripts/stage0/selftrain/s2_fullpool_build_pl.py paper_s2_fullpool_infer paper_s2_fullpool_r1
"""
