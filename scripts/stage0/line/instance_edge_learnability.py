...
throughout; the only trainable parameters are the edge head.
    ...
    python scripts/stage0/line/instance_edge_learnability.py all
    python scripts/stage0/line/instance_edge_learnability.py status
"""
...
def phase_recipe_parity(state: State) -> dict[str, Any]:
    ...
    recipe = {
        "source": "scripts/stage0/paper_s2/paper_s2_ppd_long_run.py",
...
def phase_report(state: State) -> dict[str, Any]:
    ...
    write("INSTANCE_EDGE_PROVENANCE.md",
          "# Provenance\n\n```\n" + json.dumps({
              ...
              "final_test_open_count": 0,
              "runner": "scripts/stage0/line/instance_edge_learnability.py",
