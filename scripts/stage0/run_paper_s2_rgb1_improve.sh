...
usage() {
  cat <<'EOF'
Usage:
  scripts/stage0/run_paper_s2_rgb1_improve.sh plan [options]
  scripts/stage0/run_paper_s2_rgb1_improve.sh quick [options]
  scripts/stage0/run_paper_s2_rgb1_improve.sh full --arm ARM [options]
  scripts/stage0/run_paper_s2_rgb1_improve.sh eval --phase quick|full [options]
...
Examples:
  ...
  scripts/stage0/run_paper_s2_rgb1_improve.sh plan

  # Run the complete quick screen after smoke tests pass:
  scripts/stage0/run_paper_s2_rgb1_improve.sh quick --execute

  # Run the selected full arm (example only; use quick report's BEST_ARM):
  scripts/stage0/run_paper_s2_rgb1_improve.sh full --arm full --execute
EOF
}
