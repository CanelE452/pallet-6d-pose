...
Usage:
    python scripts/stage0/paper_s2_micro_arch_screen.py --build-manifests
    python scripts/stage0/paper_s2_micro_arch_screen.py --all-primary
    python scripts/stage0/paper_s2_micro_arch_screen.py --run B2      # 조건부
    python scripts/stage0/paper_s2_micro_arch_screen.py --report
"""
...
WEIGHT_DIR = ROOT / "weights/paper_s2_micro_arch_screen"
MECH_DIR = MD.OUT_DIR
