...
GPU script. Usage:
  conda run -n pallet-pose python scripts/stage0/stage_screens/padding_edge_overlay.py
CPU-safe edge selection only (no model):
  python scripts/stage0/stage_screens/padding_edge_overlay.py --list_only
"""
