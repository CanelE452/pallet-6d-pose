...
tr = PoseTrainer(overrides=dict(
    ...
    save_period=10, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_posecls_g38", name="SMOKE_Y0",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
          ...
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_posecls_g38/SMOKE_Y0/RUNTIME_AUDIT.json", "w"), indent=2)
