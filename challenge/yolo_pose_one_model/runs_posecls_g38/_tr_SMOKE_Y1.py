...
from pallet_yolo_loss.posecls import PoseAwareClsLoss26, CALLS
from ultralytics.utils.loss import E2ELoss
from ultralytics.nn.tasks import PoseModel
PoseModel.init_criterion = lambda self: E2ELoss(self, PoseAwareClsLoss26)

from ultralytics.models.yolo.pose import PoseTrainer
tr = PoseTrainer(overrides=dict(
    task="pose", mode="train", model="/home/minjae/Documents/github/pallet-pose/challenge/weights/pretrained_yolo/yolo26n-pose.pt", data="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/g38_smoke256/data.yaml",
    ...
    save_period=10, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_posecls_g38", name="SMOKE_Y1",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
           ...
           "data": "/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/g38_smoke256/data.yaml"},
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_posecls_g38/SMOKE_Y1/RUNTIME_AUDIT.json", "w"), indent=2)
