...
tr = PoseTrainer(overrides=dict(
    ...
    save_period=10, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_posecls_g38", name="Y26_G38_Y1_POSEAWARE_CLS_30EP_SEED42",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
          ...
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_posecls_g38/Y26_G38_Y1_POSEAWARE_CLS_30EP_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
