...
tr = PoseTrainer(overrides=dict(
    task="pose", mode="train", model="/home/minjae/Documents/github/pallet-pose/challenge/weights/pretrained_yolo/yolo11n-pose.pt", data="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/g38_generic_only/data.yaml",
    ...
    save_period=10, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_arch_baseline", name="AB_G38_B11_YOLO11N_30EP_SEED42",
...
json.dump({"PSPC_CALLS": CNT["pspc"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
           ...
           "init": "/home/minjae/Documents/github/pallet-pose/challenge/weights/pretrained_yolo/yolo11n-pose.pt", "data": "/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/g38_generic_only/data.yaml",
           "fliplr": tr.args.fliplr, "flipud": tr.args.flipud,
           "params": int(sum(p.numel() for p in tr.model.parameters()))},
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_arch_baseline/AB_G38_B11_YOLO11N_30EP_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
