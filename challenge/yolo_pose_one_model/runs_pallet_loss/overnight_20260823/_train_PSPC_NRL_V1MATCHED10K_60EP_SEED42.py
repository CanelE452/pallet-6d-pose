...
os.environ["A1_CONFIG"] = "/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_pallet_loss/overnight_20260823/NRL_LOSS_CONFIG.json"
...
tr = ASCTrainer(overrides=dict(
    ...
    save_period=10, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_pallet_loss", name="PSPC_NRL_V1MATCHED10K_60EP_SEED42",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_MARGIN_CALL_COUNT": SY.ROLE_CALLS["n"],
           ...
           "seed": 42}, open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_pallet_loss/PSPC_NRL_V1MATCHED10K_60EP_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
