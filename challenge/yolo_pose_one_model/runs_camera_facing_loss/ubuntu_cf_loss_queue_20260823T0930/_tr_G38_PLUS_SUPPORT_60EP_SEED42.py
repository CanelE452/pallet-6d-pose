...
tr = PoseTrainer(overrides=dict(
    task="pose", mode="train", model="/home/minjae/Documents/github/pallet-pose/challenge/weights/pretrained_yolo/yolo26n-pose.pt", data="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/g38_plus_support/data.yaml",
    ...
    save_period=5, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss", name="G38_PLUS_SUPPORT_60EP_SEED42",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
           ...
           "n_train_batches": len(tr.train_loader), "epochs": 60, "seed": 42},
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss/G38_PLUS_SUPPORT_60EP_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
