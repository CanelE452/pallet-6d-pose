...
os.environ["A1_CONFIG"] = "/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss/ubuntu_cf_loss_queue_20260823T0930/CF_NRL_CONFIG.json"
...
SY.ROLE_CALLS["n"] = 0
from pallet_yolo_loss.trainer import ASCTrainer as T
tr = T(overrides=dict(
    ...
    project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss", name="CF_NRL_V1MATCHED10K_60EP_SEED42_UBUNTU", exist_ok=True, resume=False, val=True, plots=False))
tr.train()
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_MARGIN_CALL_COUNT": SY.ROLE_CALLS["n"],
           ...
           "seed": 42}, open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss/CF_NRL_V1MATCHED10K_60EP_SEED42_UBUNTU/RUNTIME_AUDIT.json", "w"), indent=2)
