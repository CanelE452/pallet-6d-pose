...
tr = PoseTrainer(overrides=dict(
    ...
    save_period=5, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss", name="OLD_ROOT_G38_GENERIC_ONLY_60EP_SEED42",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
           ...
           "data": "/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/g38_generic_only/data.yaml", "epochs": 60, "seed": 42},
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss/OLD_ROOT_G38_GENERIC_ONLY_60EP_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
