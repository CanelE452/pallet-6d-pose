...
tr = PoseTrainer(overrides=dict(
    ...
    project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss", name="CF_DATA_E_V2_COMPLETE12K5_STD_SMOKE_SEED42", exist_ok=True, resume=False, val=True, plots=False))
tr.train()
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
           ...
           "data": "/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/datasets/v2_cf_complete/data.yaml", "epochs": 1, "seed": 42},
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss/CF_DATA_E_V2_COMPLETE12K5_STD_SMOKE_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
