...
tr = PoseTrainer(overrides=dict(
    ...
    save_period=5, device=0, workers=8, project="/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss", name="ADAPT_N1_15EP_SEED42",
...
json.dump({"PC_CALL_COUNT": PC["n"], "ROLE_CALLS": SY.ROLE_CALLS["n"],
          ...
          open("/home/minjae/Documents/github/pallet-pose/challenge/yolo_pose_one_model/runs_camera_facing_loss/ADAPT_N1_15EP_SEED42/RUNTIME_AUDIT.json", "w"), indent=2)
