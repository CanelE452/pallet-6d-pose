...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/R5_PROPOSED__FULL/weights/last.pt`
- checkpoint SHA-256: `84793f173cca167c10790e300878e73638bac40b1245dc2829aefe39219a5a23`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.758547`
- Box AP50: `0.9580190183212638`
- 2D keypoint diagnostic: median `7.209888089744723` px; p90 `41.38014563585743` px; supervised N `2818`.
