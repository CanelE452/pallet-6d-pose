...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/B_CONF_RANDOM_S2__FULL/weights/last.pt`
- checkpoint SHA-256: `75227636b907ad50608081b86cf9ba4c1e6e151432b8cb8a33513e98e91d2ed4`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.772428`
- Box AP50: `0.9506094081954675`
- 2D keypoint diagnostic: median `4.141853300166019` px; p90 `18.86562105803838` px; supervised N `1314`.
