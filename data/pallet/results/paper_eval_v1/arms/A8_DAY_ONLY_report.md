...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/A8_DAY_ONLY__FULL/weights/last.pt`
- checkpoint SHA-256: `453a69c2b4f225267735264e2398101994f5c8b3d6a17a339df652b52d51d4b7`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.759780`
- Box AP50: `0.9401795018151303`
- 2D keypoint diagnostic: median `4.496424887540958` px; p90 `33.33579011736678` px; supervised N `1314`.
