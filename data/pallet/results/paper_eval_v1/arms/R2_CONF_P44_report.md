...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/R2_CONF_P44__FULL/weights/last.pt`
- checkpoint SHA-256: `9a5d3476ab6c05fae265a1a4a812d16a24408dbf395c44d61766327080d66803`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.749326`
- Box AP50: `0.9332690171155182`
- 2D keypoint diagnostic: median `7.141008715390949` px; p90 `37.72284263837021` px; supervised N `2818`.
