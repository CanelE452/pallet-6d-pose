...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/R2_CONF__FULL/weights/last.pt`
- checkpoint SHA-256: `79aec7369919c2a6770fb8e3b7d943f36908f1cd5450b51cd5ec8ada0d07fdb1`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.763504`
- Box AP50: `0.9466578671937682`
- 2D keypoint diagnostic: median `7.037159686619326` px; p90 `43.60616891969605` px; supervised N `2818`.
