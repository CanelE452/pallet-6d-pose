...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/R4_CONF_REMOVE__FULL/weights/last.pt`
- checkpoint SHA-256: `e97402b068d6d563c0d8ef82ee5eab4c20842a0afd894c8e0462e4c781b27735`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.757767`
- Box AP50: `0.9366227718776184`
- 2D keypoint diagnostic: median `4.312947248699946` px; p90 `29.518857395312324` px; supervised N `1314`.
