...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/B_CONF_DECILE__FULL/weights/last.pt`
- checkpoint SHA-256: `5d4b9eca39d984abe47cc5d895077615a5b1bb31f427b3407dd4a4263ad6480a`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.770351`
- Box AP50: `0.9609823895212894`
- 2D keypoint diagnostic: median `4.200597543440676` px; p90 `27.703897534885826` px; supervised N `1314`.
