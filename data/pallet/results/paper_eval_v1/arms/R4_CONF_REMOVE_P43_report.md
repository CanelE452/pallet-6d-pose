...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v1/R4_CONF_REMOVE_P43__FULL/weights/last.pt`
- checkpoint SHA-256: `c1acb82e07539c362e6be6004ef987034c8c522bb1468b874f8fca724f54d11d`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.774529`
- Box AP50: `0.9497567835404915`
- 2D keypoint diagnostic: median `7.314095967173641` px; p90 `36.36310778345659` px; supervised N `2818`.
