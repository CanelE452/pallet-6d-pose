...
- checkpoint: `data/pallet/results/pallet_dht_joint_v1/runs/hough_features_seed1/weights/final.pt`
- checkpoint SHA-256: `c26cd537b237a96db14ac84a253eff8889459d609a8660ef69ec496d488a4f72`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.747610`
- Box AP50: `0.9191026114237982`
- 2D keypoint diagnostic: median `6.998064429728268` px; p90 `41.35407735586799` px; supervised N `2818`.
