...
- checkpoint: `data/pallet/results/pallet_dht_coupling_v2/runs/balanced_pcgrad_seed1/weights/final.pt`
- checkpoint SHA-256: `d87d4158ccf8c3a293752fa8d99493bf2ebef39289bece246348934b2fd5fbe6`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.762975`
- Box AP50: `0.9319493923925205`
- 2D keypoint diagnostic: median `6.828059757132635` px; p90 `50.05347372580264` px; supervised N `2818`.
