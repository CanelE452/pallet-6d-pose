...
- checkpoint: `data/pallet/results/pallet_dht_coupling_v2/runs/incidence_seed2/weights/final.pt`
- checkpoint SHA-256: `34d87f19d58b58e8410bd3869a775805f267740387af2ee0ba7397df2734d561`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.750175`
- Box AP50: `0.9127681184763835`
- 2D keypoint diagnostic: median `6.721419476362997` px; p90 `41.503266714222036` px; supervised N `2818`.
