...
- checkpoint: `data/pallet/results/pallet_dht_coupling_v2/runs/incidence_seed1/weights/final.pt`
- checkpoint SHA-256: `134bb477bcbaae1f4e4ec312d44b7eb682cdd6712dc00b675a84c0944afbc2e4`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.747799`
- Box AP50: `0.9118090109949415`
- 2D keypoint diagnostic: median `7.061418289672594` px; p90 `40.40896998768378` px; supervised N `2818`.
