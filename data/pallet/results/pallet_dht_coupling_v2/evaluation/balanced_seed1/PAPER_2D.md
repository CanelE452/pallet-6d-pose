...
- checkpoint: `data/pallet/results/pallet_dht_coupling_v2/runs/balanced_seed1/weights/final.pt`
- checkpoint SHA-256: `110fabdc43f8df1c573dc1dc305e0131f2dcddd79bb9f891861112a53a36eb2b`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.754220`
- Box AP50: `0.9180450840609127`
- 2D keypoint diagnostic: median `6.964516476151309` px; p90 `45.27011156759148` px; supervised N `2818`.
