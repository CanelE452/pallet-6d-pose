...
- checkpoint: `data/pallet/results/pallet_dht_coupling_v2/runs/balanced_pcgrad_seed2/weights/final.pt`
- checkpoint SHA-256: `15688b26c371b636b32696d5b145514abd15b2086a94c1d72d8635af33bc2f4d`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.738748`
- Box AP50: `0.8993375094035425`
- 2D keypoint diagnostic: median `6.626853373583268` px; p90 `37.7163021084836` px; supervised N `2818`.
