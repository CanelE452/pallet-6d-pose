...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v5/V5_RELIABILITY_WEIGHTED__FULL/weights/last.pt`
- checkpoint SHA-256: `420bd5706b25cef0787d93c1cf79953c7f1d4585cd751de9244d08f427da280b`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.755940`
- Box AP50: `0.9411551088121384`
- 2D keypoint diagnostic: median `7.089976280657739` px; p90 `45.74485283119062` px; supervised N `2818`.
