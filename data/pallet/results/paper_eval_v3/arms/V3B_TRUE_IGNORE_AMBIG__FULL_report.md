...
- checkpoint: `challenge/yolo_pose_one_model/paper_selftrain_v3/V3B_TRUE_IGNORE_AMBIG__FULL/weights/last.pt`
- checkpoint SHA-256: `3446e2eeed26282e175f08d420334831dec7b2b5312aa1400168483b6c413ba5`
- populations: `PAPER_EVAL_ALL_POS` (N=319) + `DEV_NEG2689` (N=2689)
- per-frame rows: `3008`

## Development result

- Box AP50:95: `0.758991`
- Box AP50: `0.945106796277823`
- 2D keypoint diagnostic: median `7.0974289367862236` px; p90 `38.681383631492515` px; supervised N `2818`.
