# YOLO26n/m 빠른 용량 비교 — 완료

판정: `INCONCLUSIVE_INSUFFICIENT_COVERAGE`.

공통 검출 표본이 사전 최소치에 못 미쳐 판정 불가다. 짧은 초기 학습의 결과이며 용량 가설을 기각하지 않는다.
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 250 | n | 0.0005 | 20 | 미정의/미정의 | 미정의 | 146.280 | 21.450 | 317 |
| 250 | m | 0.0001 | 7 | 미정의/미정의 | 미정의 | 171.430 | 25.034 | 319 |
| 500 | n | 0.0323 | 82 | 78.426/156.695 | 0.857 | 91.248 | 20.234 | 316 |
| 500 | m | 0.0005 | 16 | 65.025/163.279 | 0.968 | 198.209 | 23.168 | 319 |
| 1000 | n | 0.0623 | 117 | 40.347/102.812 | 0.734 | 77.065 | 21.804 | 319 |
| 1000 | m | 0.0475 | 103 | 42.790/115.250 | 0.772 | 91.737 | 21.412 | 319 |

시점별 공통 검출 수: 250step=0장, 500step=7장, 1000step=73장.
...
- n: 3,043,704 parameters, 1000 updates, 학습 126.7초, peak tensor allocation 1291MiB, 샘플링된 최고 GPU 온도 63°C.
- m: 23,543,044 parameters, 1000 updates, 학습 205.2초, peak tensor allocation 4404MiB, 샘플링된 최고 GPU 온도 67°C.
- 1,000개 전체 step의 실제 증강 이미지·라벨 텐서와 학습률 일치 PASS.
