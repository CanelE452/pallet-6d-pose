...
```text
1. synthetic only 보다 self-training 이 좋은가   6.616 -> 7.120   아니오
2. naive 보다 filtering 이 좋은가                7.120 -> 7.210   아니오
3. reproj-only 보다 제안 filter 가 좋은가        7.044 -> 7.210   아니오
```
...
confidence-decile matched            259     7.256    0.9947    0.0286
Proposed (geometry) (n=3)            259     7.305    0.9938    0.0352
Confidence only, all 272             272     7.037    0.9923    0.0469
```

### 판정

```text
corner   random 7.1403  Proposed 7.3047   구간 겹침
