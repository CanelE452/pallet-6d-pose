...
────────────────────────────────────────────────────────
Low                122       9.124      10.346   +1.222
Mid                138       5.274       5.180   -0.094
High                57       5.665       6.160   +0.495
Lighting_day       168       6.591       6.708   +0.116
Lighting_night     106       5.231       5.632   +0.401
```
...
──────────────────────────────────────────────────────────────────────────────────
Naive self-training      corner↓       7.027    6.848    6.933    6.936    0.073
...
Proposed                 corner↓       7.057    7.163    7.160    7.127    0.049
...
──────────────────────────────────────────────────────────────────────────────────────
Naive, quantity-matched      corner↓       7.225    6.820    6.686    6.911    0.229
...
──────────────────────────────────────────────────────────────────────
0.25                6.876   0.984   0.9930   0.0390   10.612     9.641
0.50 (MAIN)         7.057   0.984   0.9953   0.0283   11.592    10.072
0.75                7.147   0.984   0.9916   0.0602   11.824     9.789
```

corner spread across ratios: 0.271 px (min 6.876 / max 7.147)
...
────────────────────────────────────────────────────────────────────────────────
ft_a (real157+neg259+synth12k)        5.959   0.994    0.8399   0.9991   0.0041
ft_b (patience0 ep40)                 5.543   0.994    0.8293   0.9992   0.0000
legacy v1v2 FT                        9.089   0.984    0.7172   0.9896   0.0513
Proposed (label-free)                 7.057   0.984    0.7585   0.9953   0.0283
```
...
────────────────────────────────────────────────────────────────────────────────────────────────────────
Synthetic only        6.501   0.975   0.385   0.658   0.830  0.7688   0.9921   0.0417        —       —
Naive ST              7.027   0.981   0.365   0.630   0.826  0.7622   0.9913   0.0558        —       —
Reproj-only ST        6.890   0.987   0.381   0.628   0.813  0.7643   0.9920   0.0487        —       —
Ours                  7.057   0.984   0.382   0.617   0.811  0.7585   0.9953   0.0283        —       —
```

반드시 답해야 하는 질문:

```text
1. synthetic only 보다 self-training 이 좋은가   6.501 -> 7.027   아니오
2. naive 보다 filtering 이 좋은가                7.027 -> 7.057   아니오
3. reproj-only 보다 제안 filter 가 좋은가        6.890 -> 7.057   아니오
```
...
──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
Plastic            194  strict    7.783    40.92   0.359   0.591   0.800   0.200   0.979   0.9948   0.0324       —      —
...
Nighttime           50  strict    8.897    28.45   0.299   0.541   0.811   0.189   0.960   0.9920   0.0588       —      —
Lighting_day       168  strict    6.708    43.31   0.403   0.632   0.809   0.191   0.982   0.9954   0.0294       —      —
Lighting_night     106  strict    5.632    23.11   0.449   0.694   0.878   0.122   0.981   0.9939   0.0152       —      —
Clean              184  strict    5.659    26.22   0.456   0.684   0.864   0.136   0.989   0.9968   0.0216       —      —
Occlusion          135  strict    9.351    52.22   0.274   0.519   0.734   0.266   0.978   0.9933   0.0294       —      —
Truncation          51  strict   11.132   118.22   0.248   0.453   0.714   0.286   0.922   0.9922   0.0402       —      —
Far                 59  strict    3.551    16.56   0.691   0.846   0.910   0.090   1.000   0.9959   0.0257       —      —
Low                122  strict   10.346    43.19   0.231   0.480   0.733   0.267   0.967   0.9920   0.0361       —      —
Mid                138  strict    5.180    23.31   0.486   0.709   0.874   0.126   0.993   0.9973   0.0152       —      —
...
──────────────────────────────────────────────────────────────────────────────────────────────
DOPE                    55,980      60   0.737       10.875        49.60   0.132   0.449   0.784
YOLO26n-Pose            55,980      60   0.975        6.501        38.51   0.385   0.658   0.830
```
...
────────────────────────────────────────────────────────────────────────
random matched (n=3)                 259     6.968    0.9941    0.0345
confidence-ranking top-N             259     6.973    0.9944    0.0342
confidence-decile matched            259     6.963    0.9947    0.0286
Proposed (geometry) (n=3)            259     7.127    0.9938    0.0352
Confidence only, all 272             272     6.899    0.9923    0.0469
```

### 판정

```text
corner   random 6.9680  Proposed 7.1267   구간 겹침
